...
<style type="text/css">
    ...
    table.border th { background: #1facff; color: #fff; font-weight: normal; border-bottom:solid 1px #186aa3; padding: 3mm 1mm ; text-align: left; }
...
<page backtop="10mm" backleft="5mm" backright="5mm" backbottom="30mm" footer="page; date;" >
    ...
    <page_footer>
        <hr>
        <h4>Pollen Plus</h4>
        <bookmark title="Informations" level="2"></bookmark>
    </page_footer>
